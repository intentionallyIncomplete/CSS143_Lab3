...
/****************************************************/
/* a)  passing a primitive or object will copy the  */
/* value of either. A difference is that the object */
/* will allow public methods to be accessed while   */
/* the primitive type is local to the scope of the  */
/* method and class. 								*/
/* b) when a primitive is passed to a method the 	*/
/* instance variable's value is copied and the scope*/
/* of the variable is now local to that method		*/
/* c) when an object is passed to a method that 	*/
/* object's instance is local to the method that is	*/
/* instantiating it. 								*/
/* d) the scope of the object instance is local to 	*/
/* the method that is creating it. 					*/
/****************************************************/
